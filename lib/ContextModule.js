...
class ContextModule extends Module {
	constructor(resolveDependencies, context, resourceQuery, recursive, regExp, addon, asyncMode, chunkName) {
		super();
	...
	build(options, compilation, resolver, fs, callback) {
		...
		this.resolveDependencies(fs, this.context, this.resourceQuery, this.recursive, this.regExp, (err, dependencies) => {
